...
public var StandardSurveyTask: ORKNavigableOrderedTask {
    ...
    newTreatQStep.isOptional = false
    steps += [newTreatQStep]
    ...
    newTreatDetailsStep.isOptional = false
    ...
    changeTreatQStep.isOptional = false
    ...
    changeDetailsStep.isOptional = false
    ...
    treatPhysStep.isOptional = false
    steps += [treatPhysStep]
    ...
    newPhysYesStep.isOptional = false
    ...
    comorbidYesStep.isOptional = false
    ...
    famHistStep.isOptional = false
    steps += [famHistStep]
    //if yes section
    let famHistYesID = "survey.famHistYesID"
    let famHistYesStep = ORKFormStep(identifier: famHistYesID)
    famHistYesStep.isOptional = false
    famHistYesStep.title = "Please provide any known details of the diagnosis"
